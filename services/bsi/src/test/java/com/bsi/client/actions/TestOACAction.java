...
public class TestOACAction extends MappingDispatchAction {

	private static Log log = LogFactory.getLog(TestOACAction.class);
	...
	public ActionForward generateOAC(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			//TODO set this to "N" for the live application.
			personForm.setIsOACAuthenticated("Y");
		} catch (Exception ex1) {
